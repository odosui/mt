...
const { username } = (window as any).user
  ...
  return (
    ...
    >
      <div className="publish-form">
        ...
        <p>
          Publishing makes a note visible for anyone on the internet (including
          search engines).
        </p>
        {!username && (
          <p>
            You need to set up a username first. Please{' '}
            <a href="/app/settings">proceed to the settings page</a>.
          </p>
        )}
